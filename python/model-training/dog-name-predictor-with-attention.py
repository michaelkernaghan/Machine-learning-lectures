...
def load_dog_names_from_csv(filename, limit=4000):
    names = []
...
class NameDataset(Dataset):
    def __init__(self, names, max_length=12):
        self.names = names
...
class TransformerModel(nn.Module):
    ...
    def generate(self, src, start_token_idx, end_token_idx, temperature=1.0):
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        generated_name_idx = model.generate(src, dataset.char_to_idx["*"], dataset.char_to_idx["#"], temperature=1.0)
