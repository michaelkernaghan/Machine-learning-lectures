...
# If the dataset has more than 10,000 rows, sample 10,000 rows
if num_rows > 10000:
    data = data.sample(n=10000, random_state=42)
else:
    print(f"Using the entire dataset with {num_rows} rows.")

# Ensure the relevant columns are strings before replacing commas
...
# Creating a pipeline
pipeline = Pipeline(steps=[('classifier', RandomForestClassifier(n_estimators=50, random_state=42))])
...
full_pipeline = Pipeline(steps=[('classifier', RandomForestClassifier(n_estimators=50, random_state=42))])
